...
import os
import time
from ze_vio_ceres.msg import BoundingBoxWithTime  # Importa il messaggio personalizzato
import numpy as np
...
if __name__ == '__main__':
    try:
        ...
        rospy.loginfo(f"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa Percorso del file delle predizioni: {predictions_file_path}")
