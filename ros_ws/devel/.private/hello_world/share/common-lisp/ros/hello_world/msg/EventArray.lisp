...
(cl:defclass <EventArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (events
    :reader events
    :initarg :events
    :type (cl:vector hello_world-msg:Event)
   :initform (cl:make-array 0 :element-type 'hello_world-msg:Event :initial-element (cl:make-instance 'hello_world-msg:Event))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <EventArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EventArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hello_world-msg:<EventArray> is deprecated: use hello_world-msg:EventArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <EventArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hello_world-msg:header-val is deprecated.  Use hello_world-msg:header instead.")
  (header m))
...
(cl:defmethod events-val ((m <EventArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hello_world-msg:events-val is deprecated.  Use hello_world-msg:events instead.")
  (events m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EventArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'events)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'hello_world-msg:Event))
