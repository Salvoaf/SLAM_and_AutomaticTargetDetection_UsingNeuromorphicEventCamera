...
(cl:defmethod cl:initialize-instance :after ((m <Event>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Event)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hello_world-msg:<Event> is deprecated: use hello_world-msg:Event instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Event>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hello_world-msg:x-val is deprecated.  Use hello_world-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Event>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hello_world-msg:y-val is deprecated.  Use hello_world-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'ts-val :lambda-list '(m))
(cl:defmethod ts-val ((m <Event>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hello_world-msg:ts-val is deprecated.  Use hello_world-msg:ts instead.")
  (ts m))

(cl:ensure-generic-function 'polarity-val :lambda-list '(m))
(cl:defmethod polarity-val ((m <Event>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hello_world-msg:polarity-val is deprecated.  Use hello_world-msg:polarity instead.")
  (polarity m))
