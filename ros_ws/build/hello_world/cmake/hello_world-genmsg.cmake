...
message(STATUS "hello_world: 3 messages, 0 services")

set(MSG_I_FLAGS "-Ihello_world:/home/salvatore/ros_ws/src/hello_world/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/salvatore/ros_ws/src/hello_world/msg/EventArray.msg" NAME_WE)
add_custom_target(_hello_world_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hello_world" "/home/salvatore/ros_ws/src/hello_world/msg/EventArray.msg" "std_msgs/Header:hello_world/Event"
)

get_filename_component(_filename "/home/salvatore/ros_ws/src/hello_world/msg/Event.msg" NAME_WE)
add_custom_target(_hello_world_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hello_world" "/home/salvatore/ros_ws/src/hello_world/msg/Event.msg" ""
)

get_filename_component(_filename "/home/salvatore/ros_ws/src/hello_world/msg/BoundingBoxWithTime.msg" NAME_WE)
add_custom_target(_hello_world_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hello_world" "/home/salvatore/ros_ws/src/hello_world/msg/BoundingBoxWithTime.msg" ""
)
...
_generate_msg_cpp(hello_world
  ...
  "${MSG_I_FLAGS}"
  "/opt/ros/noetic/share/std_msgs/cmake/../msg/Header.msg;/home/salvatore/ros_ws/src/hello_world/msg/Event.msg"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/hello_world)
  install(CODE "execute_process(COMMAND \"/home/salvatore/miniconda3/envs/ros_env/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/hello_world\")")
  # install generated code
  install(
